...
def normalize_non_empty_text(value: str) -> str:
    text = value.strip()
    if not text:
...
def normalize_non_empty_hint_content(value: str) -> str:
...
class Hint(BaseModel):
    ...
    def validate_content(cls, value: str) -> str:
        return normalize_non_empty_hint_content(value)

    @field_validator("creator")
    @classmethod
    def validate_creator(cls, value: str) -> str:
        return normalize_non_empty_text(value)
